/*______________________    EJERCICIO 3 - CLASE 10     ____________________________
...
Nadie puede cambiar esas definiciones, por lo tanto,
 vamos a escribirlas en dos constantes
  (asignándoles los valores numéricos 18 y 99 respectivamente). Por último, Deberás pedirle al usuario que ingrese su edad para validarla usando parseInt.
...
if ((edad >= EDAD_MINIMA) && (edad <= EDAD_MAXIMA)) {
    ...
    console.log(" ________________________________________\n No podes realizar la encuesta, estas fuera del rango de edad." );
}
